...
Husky_Collision_Constraint::Husky_Collision_Constraint(double potential_field_mag, double potential_field_exp, double husky_length, double husky_width, double husky_height, const Eigen::Matrix<double,3,1>& sensor_location_input):
    ...
    husky_envelope(husky_length,husky_width,husky_height,3,3,SuperEllipsoidKeepout::KEEP_OUT),
    husky_envelope_soft(potential_field_mag,potential_field_exp,husky_length*(1.0-1e-2),husky_width*(1.0-1e-2),husky_height*(1.0-1e-2),2.3,2.3,SuperEllipsoidKeepout::KEEP_OUT_POTENTIAL_FIELD)
{
